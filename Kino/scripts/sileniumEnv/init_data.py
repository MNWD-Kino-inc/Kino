...
if __name__ == '__main__':
    ...
    driver.get("http://localhost:8910/admin429saele3")
    ...
    chooseFile = driver.find_element(by=By.ID, value="file")
    chooseFile.send_keys("C:/xampp/htdocs/Kino/Kino/parser/final/uniq_movies.csv")
    driver.implicitly_wait(9)
    sleep(3)
    ...
    chooseFile = driver.find_element(by=By.ID, value="file")
    chooseFile.send_keys("C:/xampp/htdocs/Kino/Kino/parser/final/comb_final.csv")
    sleep(2)
